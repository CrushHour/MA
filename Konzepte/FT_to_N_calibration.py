# %%
import transfromation_functions as tf

# %%
import transformation_functions as tf

# %%
data = tf.load_json(r"Data\calibration\2023_07_12_12_33_30.json")

# %%
data = tf.get_json(r"Data\calibration\2023_07_12_12_33_30.json")
...
# %%
ft_forces[2][start:end]


# %%
np.linalg.norm(ft_forces, axis=1)
...
# %%
np.linalg.norm(ft_forces, axis=0)

# %%
ft_mean=np.linalg.norm(ft_forces, axis=0)

# %%
ft_norm=np.linalg.norm(ft_forces, axis=0)

# %%
ft_mean=np.mean(ft_norm[start:end])
...
# %%
Fg = 0.1 * 9.81
10.721048292125472/Fg

# %%
ft_mean=np.mean(ft_norm[0:200])

# %%
ft_mean

# %%
ft_norm_zero = ft_norm - ft_mean

# %%
plt.plot(ft_norm_zero)
...
# %%
ft_mean10=np.mean(ft_norm_zero[1230:1550])
print(ft_mean10)
...
# %%
ft_mean5=np.mean(ft_norm_zero[750:1050])
print(ft_mean5)
...
# %%
9.16224994369533/(0.4901*2)

# %%
np.mean([ft_mean5,ft_mean10])
